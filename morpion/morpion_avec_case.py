...
def main():
    ...
    print(f' -Bonjour {joueur1} vous jouez avec le "X" \n\n -Bonjour {joueur2} vous jouez avec le "O"')
    ...
    while compteur > 0:
        ...
        # Convertit le choix en coordonnées du plateau
        match choix:
            case 0: row, col = 0, 0
            case 1: row, col = 0, 1
            case 2: row, col = 0, 2
        ...
        if choix in deja_jouer:
            print()
            print("----------------------------------------")
            print(f"!!!!! ce chiffre a déjà été joué !!!!!")
            print("----------------------------------------")
            print()
        else:
